...
export class User implements BaseEntity {
  ...
  /**
   * The role assigned to this user account, determining access permissions.
   * @defaultValue ''
   */
   ...
   * @param props.role - The role assigned to the user
   *
   * @remarks
   * Initializes a user entity with the provided values. ID, username and role
   * are required for a valid user entity to exist.
   */
  constructor(props:{id: number, username: string, role: string}) {
    this._id = props.id;
